...
if __name__ == "__main__":
    ...
    try:
        ...
        posfix = 'node_'+str(N) +'groups_' +str(m) + 'md_'+ str(d) + "_"
        ...
        np.savetxt(posfix+"adjacency_matrix.txt", adjacency_matrix, delimiter="\t")
        ...
        nx.write_graphml(G, posfix+"random_modular_graph.graphml")
