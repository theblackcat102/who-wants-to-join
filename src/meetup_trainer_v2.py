...
class GroupGCN():
    ...
    def evaluate(self, dataloader, model):
        ...
        with torch.no_grad():
            ...
            for val_data in tqdm(dataloader, dynamic_ncols=True):
                ...
                pred = model(edge_index.cuda(), x.cuda(), label_mask.cuda())
    ...
    def train(self, epochs=200):
        ...
        model = StackedGCNMeetupV2(user_size=len(self.train_dataset.user2id),
